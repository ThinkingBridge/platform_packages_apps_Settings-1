...
public class PersonalizedSettings extends PreferenceActivity
    ...
    public void onBuildHeaders(List<Header> headers) {
        loadHeadersFromResource(R.xml.personalized_settings_headers, headers);
     ...
     */
    public static class BluetoothSettingsActivity extends PersonalizedSettings { /* empty */ }
    public static class WirelessSettingsActivity extends PersonalizedSettings { /* empty */ }
    public static class TetherSettingsActivity extends PersonalizedSettings { /* empty */ }
    public static class VpnSettingsActivity extends PersonalizedSettings { /* empty */ }
    public static class DateTimeSettingsActivity extends PersonalizedSettings { /* empty */ }
    public static class StorageSettingsActivity extends PersonalizedSettings { /* empty */ }
    public static class WifiSettingsActivity extends PersonalizedSettings { /* empty */ }
    public static class WifiP2pSettingsActivity extends PersonalizedSettings { /* empty */ }
    public static class InputMethodAndLanguageSettingsActivity extends PersonalizedSettings { /* empty */ }
    public static class KeyboardLayoutPickerActivity extends PersonalizedSettings { /* empty */ }
    public static class InputMethodAndSubtypeEnablerActivity extends PersonalizedSettings { /* empty */ }
    public static class SpellCheckersSettingsActivity extends PersonalizedSettings { /* empty */ }
    public static class LocalePickerActivity extends PersonalizedSettings { /* empty */ }
    public static class UserDictionarySettingsActivity extends PersonalizedSettings { /* empty */ }
    public static class SoundSettingsActivity extends PersonalizedSettings { /* empty */ }
    public static class DisplaySettingsActivity extends PersonalizedSettings { /* empty */ }
    public static class DeviceInfoSettingsActivity extends PersonalizedSettings { /* empty */ }
    public static class ApplicationSettingsActivity extends PersonalizedSettings { /* empty */ }
    public static class ManageApplicationsActivity extends PersonalizedSettings { /* empty */ }
    public static class StorageUseActivity extends PersonalizedSettings { /* empty */ }
    public static class DevelopmentSettingsActivity extends PersonalizedSettings { /* empty */ }
    public static class AccessibilitySettingsActivity extends PersonalizedSettings { /* empty */ }
    public static class SecuritySettingsActivity extends PersonalizedSettings { /* empty */ }
    public static class LocationSettingsActivity extends PersonalizedSettings { /* empty */ }
    public static class PrivacySettingsActivity extends PersonalizedSettings { /* empty */ }
    public static class RunningServicesActivity extends PersonalizedSettings { /* empty */ }
    public static class ManageAccountsSettingsActivity extends PersonalizedSettings { /* empty */ }
    public static class PowerUsageSummaryActivity extends PersonalizedSettings { /* empty */ }
    public static class AccountSyncSettingsActivity extends PersonalizedSettings { /* empty */ }
    public static class AccountSyncSettingsInAddAccountActivity extends PersonalizedSettings { /* empty */ }
    public static class CryptKeeperSettingsActivity extends PersonalizedSettings { /* empty */ }
    public static class DeviceAdminSettingsActivity extends PersonalizedSettings { /* empty */ }
    public static class DataUsageSummaryActivity extends PersonalizedSettings { /* empty */ }
    public static class AdvancedWifiSettingsActivity extends PersonalizedSettings { /* empty */ }
    public static class TextToSpeechSettingsActivity extends PersonalizedSettings { /* empty */ }
    public static class AndroidBeamSettingsActivity extends PersonalizedSettings { /* empty */ }
    public static class WifiDisplaySettingsActivity extends PersonalizedSettings { /* empty */ }
    public static class ApnSettingsActivity extends PersonalizedSettings { /* empty */ }
    public static class ApnEditorActivity extends PersonalizedSettings { /* empty */ }
    public static class ProfilesSettingsActivity extends PersonalizedSettings { /* empty */ }
    public static class QuietHoursSettingsActivity extends PersonalizedSettings { /* empty */ }
    public static class DreamSettingsActivity extends PersonalizedSettings { /* empty */ }
    public static class ROMSettingsActivity extends PersonalizedSettings { /* empty */ }
}